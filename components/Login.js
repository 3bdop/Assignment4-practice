import { StyleSheet, TextInput, View, TouchableOpacity, Text, KeyboardAvoidingView, Platform, Image } from 'react-native'
        ...
        <KeyboardAvoidingView style={styles.container} behavior={Platform.OS == "ios" ? "padding" : "height"}
            ...
            <View style={styles.inputContainer}>
                ...
                <TextInput
                    ...
                    style={[styles.input, { borderColor: passWrong ? 'red' : '', borderWidth: passWrong ? 2 : 0 }]}
                    secureTextEntry
